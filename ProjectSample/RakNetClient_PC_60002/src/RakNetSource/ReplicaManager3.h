...
/// \pre Parent class must call SetCompositeOwner() on this object
    ...
    class RAK_DLL_EXPORT Replica3Composite : public Replica3
    {
        ...
        public:
            ...
            virtual void OnSerializeTransmission(RakNet::BitStream* bitStream, RakNet::Connection_RM3* destinationConnection, RakNet::BitSize_t bitsPerChannel[RakNet::RM3_NUM_OUTPUT_BITSTREAM_CHANNELS], RakNet::Time curTime)
            {
